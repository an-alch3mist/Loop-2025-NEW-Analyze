    ...
    public class PythonInterpreter
    {
        ...
        private object EvaluateBinary(BinaryExpr expr)
        {
            ...
            switch (expr.Operator)
            {
                ...
                case TokenType.EQUAL_EQUAL: return AreEqual(leftValue, rightValue);
                case TokenType.BANG_EQUAL: return !AreEqual(leftValue, rightValue);
        ...
        private object EvaluateSlice(SliceExpr expr)
        {
            ...
            if (!(obj is List<object>))
            {
                throw new RuntimeError("Can only slice lists");
            }
        ...
        private object EvaluateMemberAccess(MemberAccessExpr expr)
        {
            ...
            throw new RuntimeError("Can only access members of enums and class instances");
        }
